...
#define NODE_MAIN_LOGGER_NAME "rm_camera_driver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librm_camera_driver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<fyt::camera_driver::HikCameraNode>";
